...
import styles from './DropdownShareButton.css';

export interface DropdownShareButtonProps {
  prop?: string;
}

export function DropdownShareButton({prop = 'default value'}: DropdownShareButtonProps) {
  return (
    <button className={styles.DropdownShareButton}>
