...
import styles from './DropdownSaveButton.css';

export interface DropdownSaveButtonProps {
  prop?: string;
}

export function DropdownSaveButton({prop = 'default value'}: DropdownSaveButtonProps) {
  return (
    <button className={styles.DropdownSaveButton}>
