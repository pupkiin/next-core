...
import styles from './DropdownHideButton.css';

export interface DropdownHideButtonProps {
  prop?: string;
}

export function DropdownHideButton({prop = 'default value'}: DropdownHideButtonProps) {
  return (
    <button className={styles.DropdownHideButton}>
